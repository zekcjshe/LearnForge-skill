...
ch5_dir = 'F:/文档/Notion_Obsidian/Notion/备考/笔记簿/08-密码学笔记库/第5章-数字签名'
archive_path = 'E:/LearnForge-skill/transcripts/ch5_all_transcripts.json'
vault_root = 'F:/文档/Notion_Obsidian/Notion/备考/笔记簿/08-密码学笔记库'

files = sorted(glob.glob(os.path.join(ch5_dir, '*.md')))
print(f"=== 开始全量审计第5章笔记 ({len(files)} 篇) ===")
